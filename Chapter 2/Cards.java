//10/12
//Seems to be confusion here. You should check in with me or a peer.
...
public class Cards
{
    ...
    public static void main(String[] args)
    {
        ...
        int card1Val = 3;//should be using ordinal()
        int card2Val = 7;    
        ...
        System.out.print("Hand value: " + (card1.ordinal() + card2.ordinal() + 2));//each ordinal should + 1
    }
}